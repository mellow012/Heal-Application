...
async function GET(request) {
    try {
        ...
        const userDoc = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["adminDb"].collection('users').doc(userId).get();
        if (!userDoc.exists) {
...
async function PUT(request) {
    try {
        ...
        await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$firebaseAdmin$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__$3c$locals$3e$__["adminDb"].collection('users').doc(userId).update(updateData);
...
//# sourceMappingURL=%5Broot-of-the-server%5D__90af4ce9._.js.map