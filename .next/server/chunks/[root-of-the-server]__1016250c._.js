...
"[project]/.next-internal/server/app/api/hospital/verify-admin/route/actions.js [app-rsc] (server actions loader, ecmascript)": ((__turbopack_context__) => {
"use strict";
...
"[project]/src/app/api/hospital/verify-admin/route.ts [app-route] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
async function POST(request) {
    try {
        ...
        if (hospitalData?.adminUserId !== userId) {
            ...
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                success: false,
                error: 'Unauthorized - You are not the admin of this hospital'
            }, {
                status: 403
            });
        }
...
//# sourceMappingURL=%5Broot-of-the-server%5D__1016250c._.js.map